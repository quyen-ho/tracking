...
export const solveMouth = (lm) => {
  ...
  const topMiddle = new Vector(lm[168]);
  const botMiddle = new Vector(lm[13]);
  console.log("botMiddle: ", botMiddle.x);
  console.log("topMiddle:", topMiddle.x);
